//Long version of the Fenwick Tree from the book. Changing main() to test quiz questions.
#include <bits/stdc++.h>
using namespace std;
...
int main() {
// RUPQ ft(100);  //Question 5
// for (int i=5; i<=10; i++) 
//     ft.range_update(i,i+3,1);
// cout << ft.point_query(2);
 
RUPQ ft(100);  //Question 4
for (int i=1; i<=10; i++) 
    ft.range_update(i,i+10,1);
cout << ft.point_query(17);

// FenwickTree ft(100); //Question 3
// for (int i=1; i<=10; i++) 
//     ft.update(i,i&3);
// cout << ft.rsq(1,2);

// FenwickTree ft(100); //Question 2
// for (int i=1; i<=10; i++) 
//     ft.update(i,i);
// cout << ft.rsq(2,50);
 
// FenwickTree ft(100); //Question 1
// for (int i=1; i<=10; i++) 
//     ft.update(i,3);
// cout << ft.rsq(9,90);
cout << endl;
